var AVideoPlayer = function() {
  ...
  this.elControlForward= null;
  this.elControlStop   = null;
  ...
  this._initElements = function() {
    ...
    this.elControlForward= document.getElementById('control-forward');
    this.elControlStop   = document.getElementById('control-stop');
  ...
  */
  ...
  this.isControlVisible = function(isVisible) {
    this.elControlStop.setAttribute("visible", isVisible);
    this.elControlBack.setAttribute("visible", isVisible);
    this.elControlForward.setAttribute("visible", isVisible);
  ...
  */
  ...
  this._addControlsEvent = function() {
    ...
    this.elControlBack.addEventListener('click', function () {
      that._playAudioAlert();
      that.elVideo.currentTime -= 10;
    });

    this.elControlForward.addEventListener('click', function () {
      that._playAudioAlert();
      that.elVideo.currentTime += 10;
    });

    this.elControlStop.addEventListener('click', function () {
      that._playAudioAlert();
      that.elVideo.pause();
